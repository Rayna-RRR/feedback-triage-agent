...
- B004: P1 / 账号、隐私与数据问题 / 同时命中多个问题类型
- B006: P1 / 账号、隐私与数据问题 / 同时命中多个问题类型
- B010: P1 / 不明确/其他 / 分类低置信度
- B016: P2 / 不明确/其他 / 分类低置信度
- B019: P2 / 不明确/其他 / 分类低置信度
- B021: P2 / 不明确/其他 / 分类低置信度
- B022: P2 / 不明确/其他 / 分类低置信度
- B024: P2 / 不明确/其他 / 分类低置信度
- B025: P2 / 不明确/其他 / 分类低置信度
- B027: P2 / 不明确/其他 / 文本过短；分类低置信度
- B029: P2 / 不明确/其他 / 分类低置信度
